...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-cyan-500">
      
      {/* 1. Detalhes de Fundo (Glow Neon Cyberpunk) */}
      ...
      <div className="w-full max-w-[440px] relative z-10 transition-all duration-1000">
        
        {/* 2. Brilho de Borda (Glow) atrás do Card */}
        <div className="absolute -inset-1.5 bg-gradient-to-r from-cyan-600 to-blue-700 rounded-3xl blur opacity-30 group-hover:opacity-50 transition"></div>
        
        {/* 3. Card Principal (Efeito de Vidro e Alta Tecnologia) */}
        <div className="relative bg-[#0d0d0d]/90 backdrop-blur-xl border border-white/10 p-12 rounded-3xl shadow-[0_0_60px_rgba(6,182,212,0.12)]">
          
          {/* Header Premium com Gradiente Jobren */}
          <div className="text-center mb-12 relative">
            ...
            <div className="h-[2px] w-24 bg-gradient-to-r from-cyan-500 to-blue-600 mx-auto mt-2.5 shadow-[0_0_15px_#06b6d4]"></div>
            <p className="mt-5 text-gray-500 text-[10px] uppercase font-bold tracking-[0.35em]">Sistema de Gestão Integrado</p>
          </div>

          {/* Formulário com UX Refinada */}
          ...
          <div className="mt-12 flex items-center justify-between text-[9px] font-bold text-gray-600 uppercase tracking-tighter border-t border-white/5 pt-8">
            <span className="hover:text-cyan-600 transition cursor-default">Security Hub</span>
            <div className="h-1.5 w-1.5 bg-cyan-900 rounded-full shadow-[0_0_5px_#164e63]"></div>
            <span className="hover:text-cyan-600 transition cursor-default tracking-widest">© 2026 JOBREN</span>
          </div>
        </div>
      </div>
    </div>
